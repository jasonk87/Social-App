const aiSettingsState = { saved: null, profiles: [], signedIn: false, busy: false, thinking: true };
...
function renderSavedAISettings() {
    ...
    if (!settings) return;
    aiElement('ai-current').textContent = `Currently used throughout the app: ${settings.model}`;
}
